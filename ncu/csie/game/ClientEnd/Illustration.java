...
public class Illustration extends State{
	...
	public Illustration(GameHandler handler) {
		super(handler);
		...
		uiManager.addObject(new UIImageButton(handler.getWidth()-140,handler.getHeight()/2-50
				, 100, 80, Assets.btn_right, new ClickListener(){
			@Override
			public void onClick() {	
